...
// - If we "import", it load ESM from "abort-controller-es5/module". The default imported object is () => any.
// - If we "require", it load CJS from "abort-controller-es5/main". The default imported object is () => any.

// When bundling with Webpack:
// - Nomatter we "import" or "require", it always load ESM from "abort-controller-es5/module", based on the "webpack.config.json/mainFields".
